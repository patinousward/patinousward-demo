package com.patinousward.demo.nospringbootjsersey.conf;
...
@Component
@Configuration
@ComponentScan(basePackages = {"com.patinousward.demo.nospringbootjsersey"})
public class SpringJavaConfiguration {
    ...
    @Bean(name = "mapper", autowire = Autowire.BY_TYPE)//byname也成?
    public MapperScannerConfigurer getMapperScannerConfigurer() {
        MapperScannerConfigurer conf = new MapperScannerConfigurer();
        conf.setBasePackage("com.patinousward.demo.nospringbootjsersey.mapper");
